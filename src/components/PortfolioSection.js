...
const PortfolioSection = () => {
  const projects = [
    ...
    { title: 'Dashboard Design using Streamlit', description: 'The "Dashboard Design for Stock Data" project utilizes Streamlit, a Python library, to develop an interactive and user-friendly dashboard for analyzing stock market data. This project aims to provide a powerful tool for investors, traders, and financial analysts to monitor and analyze stock performance.', image: image3, projectLink:"/ECommerceReport_Project1" },
